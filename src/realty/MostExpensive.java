 ...
 * @author Вадим
 */
public class MostExpensive extends javax.swing.JFrame {
     ...
     private void FillTable(JTable table, String Query)
{
    ...
    catch(SQLException e)
    {
     ...
     public void updateDB(){
        FillTable(jTableMostExpensive,"select r.street,r.house,r.flat,r.area,r.floor, r.room_numb,r.cost,r.fh\n" +
...
"limit 10");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(MostExpensive.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostExpensive.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostExpensive().setVisible(true);
            }
        });
    }
